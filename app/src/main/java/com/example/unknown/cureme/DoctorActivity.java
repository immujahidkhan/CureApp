...
public class DoctorActivity extends AppCompatActivity {
    ...
    private void loadData() {
        ...
        while (res.moveToNext()) {
            ...
            list.add(new MyModelClass(res.getString(0), res.getString(1), res.getString(2), res.getString(3), res.getString(4), res.getString(5), res.getString(6), res.getString(7), res.getString(8)));
        }
