...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String COL_11 = "COMMENTS";
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("create table " + TABLE_NAME + "(ID INTEGER PRIMARY KEY AUTOINCREMENT,patient_ID TEXT,NAME TEXT, BLOOD TEXT, SUGAR TEXT, TEMPERATURE INTEGER, BP INTEGER, HEARTBEAT INTEGER, COMMENTS TEXT)");
    ...
    public boolean updateData(String id, String comment) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
        contentValues.put(COL_1, id);
        contentValues.put(COL_11, comment);
